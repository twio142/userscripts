...
// @updateURL       https://raw.githubusercontent.com/twio142/userscripts/refs/heads/main/geniusLyrics.user.js
// @downloadURL     https://raw.githubusercontent.com/twio142/userscripts/refs/heads/main/geniusLyrics.user.js
// ==/UserScript==
      ...
      combine: function themeSpotifyCombineGeniusResources (song, html, annotations, onCombine) {
        ...
        headhtml += `<style>
            ...
            *[class*=HeaderArtistAndTracklist][class*=__Tracklist] [class*=Link__StyledLink] {
            ...
            html .lyrics_body_pad > div:first-child {
              margin: unset;
              padding-bottom: 25px;
            }
            ${iframeCSSCommon}
...
`
  ...
  function contentStyling (iframeWidth) {
    ...
    if (genius.style.enabled !== true) return setWidth
    if (typeof genius.style.setup === 'function') {
      if (genius.style.setup() === false) return setWidth
    }
...
Link__StyledLink
  ...
  async function trimHTMLReponseTextFn (htmlText) {
    ...
    */
    ...
    htmlText = htmlText.replace(/[\t\x20\u0009-\u000D\^E\u00A0\u1680\u2000-\u200A\u2028-\u2029\u202F\u205F\u3000]+/g, ' ') /* spacing */ // eslint-disable-line no-control-regex
  ...
  function showLyrics (songInfo, searchresultsLengths) {
    ...
    async function showLyricsRunner () {
      try {
        ...
        const contentStyle = contentStyling(iframe?.style.width) || '' // obtained from the main window, to be passed to iframe
